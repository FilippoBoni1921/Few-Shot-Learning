...
argparser.add_argument("--algorithm", choices=["maml", "pnet"], default="pnet", help="What meta-learning algorithm to use")
...
argparser.add_argument("--results_dir", default=None, type=str, help="Directory to store results in")
...
if args.algorithm == "maml":
    constr = MAML(num_ways=args.num_ways,
                  T=args.T,
    ...
    constr = PrototypicalNetwork(num_ways=args.num_ways,
                                 T=args.T,
                                 input_size=args.img_size ** 2,
                                 rgb=args.rgb,
                                 img_size=args.img_size)

model = constr # images are of size 28x28
